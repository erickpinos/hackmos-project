...
export declare const newSignerFromKeplr: (keplr: Keplr, chainId: string) => import("@keplr-wallet/types").OfflineAminoSigner & import("@keplr-wallet/types").OfflineDirectSigner;
/**
