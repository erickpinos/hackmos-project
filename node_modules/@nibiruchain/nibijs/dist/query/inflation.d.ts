...
import { QueryCirculatingSupplyResponse, QueryEpochMintProvisionResponse, QueryInflationRateResponse, QueryParamsResponse, QueryPeriodResponse, QuerySkippedEpochsResponse } from "@nibiruchain/protojs/dist/nibiru/inflation/v1/query";
...
export declare const setupInflationExtension: (base: QueryClient) => InflationExtension;
